...
<xsl:stylesheet version="1.0" xmlns="http://schema.slothsoft.net/amber/amberdata" xmlns:saa="http://schema.slothsoft.net/amber/amberdata" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:exsl="http://exslt.org/common" xmlns:func="http://exslt.org/functions"
    ...
    <xsl:template name="extract-graphics">
        <gfx-archive-list>
            <!-- 'Static_data.amb' => [ 'width' => [16, 32], 'bitplanes' => [3, 5], 'palette' => 0, 'color' => 24, ], 'Palettes.amb' => [ 'width' => 256, 'bitplanes' => 2, 'palette' => 0, ], 'Lab_background.amb' => [ 'width' => 144, 'bitplanes' => 4, 'palette' => 0, ], 'Floors.amb' => [ 'width' => 64, 
                'bitplanes' => 4, 'palette' => 0, ], '1Icon_gfx.amb' => [ 'width' => 16, 'bitplanes' => 5, 'palette' => null, ], '2Icon_gfx.amb' => [ 'width' => 16, 'bitplanes' => 5, 'palette' => null, ], '3Icon_gfx.amb' => [ 'width' => 16, 'bitplanes' => 5, 'palette' => null, ], 'Automap_graphics' => [ 'width' => null, 
                'bitplanes' => null, 'palette' => 0, ], 'Combat_background.amb' => [ 'width' => 320, 'bitplanes' => 5, 'palette' => 5, ], 'Combat_graphics' => [ 'width' => null, 'bitplanes' => null, 'palette' => 0, ], 'Event_pix.amb' => [ 'width' => 320, 'bitplanes' => 5, 'palette' => 31, ], 'Layouts.amb' => [ 'width' 
                => 320, 'bitplanes' => 3, 'palette' => 10, ], 'Monster_gfx.amb' => [ 'width' => 80, //[64, 48, 80, 96], //[48, 64, 96, 128], 'bitplanes' => 5, 'palette' => null, ], 'NPC_gfx.amb' => [ 'width' => 16, 'bitplanes' => 5, 'palette' => null, ], 'Object_icons' => [ 'width' => 16, 'bitplanes' => 5, 'palette' 
                => 49, ], 'Party_gfx.amb' => [ 'width' => 16, 'bitplanes' => 5, 'palette' => 0, ], 'Pics_80x80.amb' => [ 'width' => 80, 'bitplanes' => 5, 'palette' => 49, ], 'PICS80.AMB' => [ 'width' => 80, 'bitplanes' => null, 'palette' => 49, ], 'Portraits.amb' => [ 'width' => 32, 'bitplanes' => 5, 'palette' => 49, 
                //'createSprite' => true, ], 'Stationary' => [ 'width' => [32, 48], 'bitplanes' => 5, 'palette' => 0, ], 'Travel_gfx.amb' => [ 'width' => 16, 'bitplanes' => 4, 'palette' => null, ], -->
            ...
            <!-- <gfx-archive file-name="transports" file-path="Amberfiles/Travel_gfx.amb"> <for-each-file width="16" bitplanes="4" palette="0" transparent="0"/> </gfx-archive> <gfx-archive file-name="tilesets.floor" file-path="Amberfiles/Floors.amb"> <for-each-file width="64" bitplanes="4" palette="0" 
                transparent="0"/> </gfx-archive> -->
    ...
    <xsl:template name="extract-gfx">
        ...
        <gfx id="{.//*[@name='gfx-id']/@value}" sourge-width="{$width/*[@name = 'source']/@value}" source-height="{$height/*[@name = 'source']/@value}" target-width="{$width/*[@name = 'target']/@value}" target-height="{$height/*[@name = 'target']/@value}">
