...
<xsl:stylesheet version="1.0" xmlns="http://schema.slothsoft.net/amber/amberdata" xmlns:saa="http://schema.slothsoft.net/amber/amberdata"
	xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:exsl="http://exslt.org/common" xmlns:func="http://exslt.org/functions" xmlns:str="http://exslt.org/strings" xmlns:set="http://exslt.org/sets"
	xmlns:math="http://exslt.org/math" xmlns:php="http://php.net/xsl" xmlns:save="http://schema.slothsoft.net/savegame/editor" xmlns:sse="http://schema.slothsoft.net/savegame/editor"
	...
	<xsl:key name="dictionary-option" match="saa:amberdata/saa:dictionary-list/saa:dictionary/saa:option" use="../@dictionary-id" />	<xsl:key name="string-dictionary" match="sse:instruction[@type='string-dictionary']/sse:string" use="../@name" />
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				<xsl:if test="../@dictionary-ref">
					<xsl:variable name="option" select="saa:getDictionaryOption(../@dictionary-ref, count(preceding-sibling::*))" />
				...
				<xsl:choose>
					...
					<xsl:when test="$lib = 'maps.3d'">
						<xsl:call-template name="extract-maps">
							<xsl:with-param name="maps" select="sse:archive[contains(@name, 'Map_data.amb')]/*
					...
					<xsl:when test="$lib = 'worldmap.lyramion'">
						<xsl:call-template name="extract-worldmap">
							<xsl:with-param name="maps" select="sse:archive[contains(@name, 'Map_data.amb')]/*[position() &lt;= 16]" />
						</xsl:call-template>
					</xsl:when>
	...
	<xsl:template name="extract-graphics">
		<gfx-archive-list>
			<!-- 'Static_data.amb' => [ 'width' => [16, 32], 'bitplanes' => [3, 5], 'palette' => 0, 'color' => 24, ], 'Palettes.amb' => [ 'width' => 256, 'bitplanes' => 2, 'palette' => 0, ], 'Lab_background.amb' 
				=> [ 'width' => 144, 'bitplanes' => 4, 'palette' => 0, ], 'Floors.amb' => [ 'width' => 64, 'bitplanes' => 4, 'palette' => 0, ], '1Icon_gfx.amb' => [ 'width' => 16, 'bitplanes' => 5, 'palette' => null, 
				], '2Icon_gfx.amb' => [ 'width' => 16, 'bitplanes' => 5, 'palette' => null, ], '3Icon_gfx.amb' => [ 'width' => 16, 'bitplanes' => 5, 'palette' => null, ], 'Automap_graphics' => [ 'width' => null, 'bitplanes' 
				=> null, 'palette' => 0, ], 'Combat_background.amb' => [ 'width' => 320, 'bitplanes' => 5, 'palette' => 5, ], 'Combat_graphics' => [ 'width' => null, 'bitplanes' => null, 'palette' => 0, ], 'Event_pix.amb' 
				=> [ 'width' => 320, 'bitplanes' => 5, 'palette' => 31, ], 'Layouts.amb' => [ 'width' => 320, 'bitplanes' => 3, 'palette' => 10, ], 'Monster_gfx.amb' => [ 'width' => 80, //[64, 48, 80, 96], //[48, 64, 
				96, 128], 'bitplanes' => 5, 'palette' => null, ], 'NPC_gfx.amb' => [ 'width' => 16, 'bitplanes' => 5, 'palette' => null, ], 'Object_icons' => [ 'width' => 16, 'bitplanes' => 5, 'palette' => 49, ], 'Party_gfx.amb' 
				=> [ 'width' => 16, 'bitplanes' => 5, 'palette' => 0, ], 'Pics_80x80.amb' => [ 'width' => 80, 'bitplanes' => 5, 'palette' => 49, ], 'PICS80.AMB' => [ 'width' => 80, 'bitplanes' => null, 'palette' => 49, 
				], 'Portraits.amb' => [ 'width' => 32, 'bitplanes' => 5, 'palette' => 49, //'createSprite' => true, ], 'Stationary' => [ 'width' => [32, 48], 'bitplanes' => 5, 'palette' => 0, ], 'Travel_gfx.amb' => [ 
			...
			<!-- <gfx-archive file-name="transports" file-path="Amberfiles/Travel_gfx.amb"> <for-each-file width="16" bitplanes="4" palette="0" transparent="0"/> </gfx-archive> <gfx-archive file-name="tilesets.floor" 
				file-path="Amberfiles/Floors.amb"> <for-each-file width="64" bitplanes="4" palette="0" transparent="0"/> </gfx-archive> -->
			...
			<xsl:if test="count($monsters)">
				<gfx-archive file-name="monsters" file-path="Amberfiles/Monster_gfx.amb">
					<xsl:for-each select="$monsters">
						<file id="{.//*[@name='gfx-id']/@value}" width="{.//*[@name='width']/*[@name='source']/@value}" height="{.//*[@name='height']/*[@name='source']/@value}" bitplanes="5" palette="15"
							transparent="1" />
					</xsl:for-each>
				</gfx-archive>
			</xsl:if>
	...
	<xsl:template name="extract-monster">
		<xsl:param name="root" select="." />
		<xsl:param name="id" />
		<monster id="{$id}" attack="{*[@name = 'attack']/@value + *[@name = 'combat-attack']/@value}" defense="{*[@name = 'defense']/@value + *[@name = 'combat-defense']/@value}">
			...
			<race>
				...
				<xsl:for-each select=".//*[@name = 'attributes']/*">
					<attribute name="{saa:getName()}" current="{*[@name = 'current']/@value + *[@name = 'current-mod']/@value}" maximum="{*[@name = 'current']/@value}" />
				</xsl:for-each>
			</race>
			<class>
				<xsl:apply-templates select=".//*[@name = 'name']" mode="attr">
				...
				<xsl:for-each select=".//*[@name = 'skills']/*">
					<skill name="{saa:getName()}" current="{*[@name = 'current']/@value + *[@name = 'current-mod']/@value}" maximum="{*[@name = 'current']/@value}" />
				</xsl:for-each>
			</class>
	...
	<xsl:template name="extract-gfx">
		...
		<gfx id="{.//*[@name='gfx-id']/@value}" sourge-width="{$width/*[@name = 'source']/@value}" source-height="{$height/*[@name = 'source']/@value}" target-width="{$width/*[@name = 'target']/@value}"
