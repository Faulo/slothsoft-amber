...
<xsl:stylesheet version="1.0" xmlns="http://schema.slothsoft.net/amber/amberdata" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:saa="http://schema.slothsoft.net/amber/amberdata" xmlns:sse="http://schema.slothsoft.net/savegame/editor"
    xmlns:sfx="http://schema.slothsoft.net/farah/xslt" xmlns:exsl="http://exslt.org/common" xmlns:set="http://exslt.org/sets">
    ...
    <xsl:template name="dictionary.characters">
        ...
        <dictionary dictionary-id="skills-or-null">
            ...
            <option key="4" val="KRI" title="Kritische Treffer" />
