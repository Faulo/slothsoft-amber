                                                        ...
                                                        <div>
                                                            <xsl:call-template name="savegame.table">
                                                                ...
                                                                <xsl:with-param name="items">
                                                                    ...
                                                                    <xsl:apply-templates select=".//*[@name = 'charges-max']" mode="item">
                                                                        <xsl:with-param name="size" select="3" />
                                                                    </xsl:apply-templates>
                                                                    <xsl:apply-templates select=".//*[@name = 'price-per-charge']" mode="item">
                                                                        <xsl:with-param name="size" select="3" />
                                                                    </xsl:apply-templates>
                                                                    <xsl:apply-templates select=".//*[@name = 'recharges-default']" mode="item">
                                                                        <xsl:with-param name="size" select="3" />
                                                                    </xsl:apply-templates>
                                                                    <xsl:apply-templates select=".//*[@name = 'recharges-max']" mode="item">
                                                                        <xsl:with-param name="size" select="3" />
                                                                    </xsl:apply-templates>
                                                                </xsl:with-param>
                                                            </xsl:call-template>
