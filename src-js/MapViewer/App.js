...
export function viewMap(mapNode, tilesetNode) {
	Promise.all([
		import("./index"),
		import("@slothsoft/farah"),
		import("pixi.js"),
	])
		.then(([amber, farah, pixi]) => {
			new amber.MapViewer.App(mapNode, tilesetNode, pixi);
		});
}

export function App(mapNode, tilesetNode, PIXI) {
	PIXI.utils.sayHello("Amber MapViewer App 0.1");
	this.mapNode = mapNode;
	this.tilesetNode = tilesetNode;
	
	this.init();
}
App.prototype = Object.create(
	Object.prototype, {
